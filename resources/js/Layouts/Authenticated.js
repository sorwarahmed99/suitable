...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-slate-900">
            <nav className="bg-white dark:bg-slate-800 border-b border-gray-100 dark:border-slate-500 sticky">
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('home')} active={route().current('home')}>
                            Interest
                        </ResponsiveNavLink><ResponsiveNavLink href={route('home')} active={route().current('home')}>
                            Chat
                        </ResponsiveNavLink>
                    </div>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200">
                        <div className="px-4">
                            <div className="font-medium text-base text-gray-800 dark:text-slate-50">{auth.user.name}</div>
            ...
            {header && (
                <header className="mt-4 ">
                    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-current w-4 h-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
