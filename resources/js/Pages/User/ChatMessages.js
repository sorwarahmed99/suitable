...
const ChatMessages = ({ auth }) => {
    ...
    const messagelist = messages.map((message) => {
        if (message.recipient_id === auth.user.id) {
            return (
                <div key={message.id} class="flex items-end">
                                ...
                                <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200 dark:border-slate-700">
                                    <div class="relative flex items-center space-x-4">
                                        <div class="relative">
                                            ...
                                            <img
                                                src={`http://localhost:3000/${user.profile_image || Img}`}
                                                alt=""
                                    ...
                                    <div className="text-lg font-semibold text-slate-500">
                                        <Dropdown>
                                            ...
                                            <Dropdown.Content className="w-10 z-auto" >
                                                <Dropdown.Link href={route('report', user.id)} method="get" as="button">
                                                    Clear chat
                                                </Dropdown.Link>
                                                <Dropdown.Link href={route('block-user', user.id)} method="post" as="button">
                                                    Block
                                                </Dropdown.Link>
                                                <Dropdown.Link href={route('report', user.id)} method="get" as="button">
                                                    Report
