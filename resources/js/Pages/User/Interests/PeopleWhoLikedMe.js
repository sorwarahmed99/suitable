                        ...
                        <div className="py-2">
                            <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                                <div className="overflow-hidden ">
                                    <div className="">
                                        {inviters.map(({ id, firstname, lastname, gender, age, country, recidency_status, ethnic_origin, profile_image, highest_education, current_profession, prayer_frequency, sect, saved, isFollowing, isSaved, isInvited, isAccepted, amiInvited }) => (
                                            <div key={id} className="flex-none sm:flex bg-white dark:bg-slate-800 shadow-md sm:rounded-lg  space-y-2 mb-4">
                                                ...
                                                <div className="flex-auto p-6 pt-0 sm:ml-3 justify-evenly">
                                                    <div className="flex items-center sm:mt-2">
                                                        <div className="flex flex-col ">
                                                            ...
                                                            <div className="flex-auto text-gray-700 dark:text-gray-400">
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div className="flex space-x-4 mt-1 text-sm font-medium">
