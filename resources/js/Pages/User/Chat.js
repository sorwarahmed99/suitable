                            ...
                            <div class="entry cursor-pointer p-2 transform hover:scale-105 duration-300 transition-transform bg-white flex shadow-md">
                                <div class="flex-2">
                                    <div class="w-12 h-12 relative">
                                        <img class="w-12 h-12 rounded-full mx-auto" src={`http://localhost:3000/${props.auth.user.profile_image}`} alt={`${props.auth.user.firstname}'s Profile photo`} alt="chat-user" />
