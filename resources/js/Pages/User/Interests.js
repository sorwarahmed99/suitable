                    ...
                    <div className="py-2">
                        <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                            <div className="overflow-hidden ">
                                <div className="">
                                    {savedusers.map(({ id, firstname, lastname, gender, age, country, recidency_status, ethnic_origin, profile_image, highest_education, current_profession, prayer_frequency, sect, saved, isFollowing, isSaved, isInvited, isAccepted }) => (
                                    ...
                                    {savedusers.length === 0 && (
                                        <p className="text-2xl font-semibold text-slate-800 dark:text-slate-50">No saved users</p> 
                                    )}
                                    {savedusers.length !== 0 && (
