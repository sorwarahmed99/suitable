            ...
            <div className="bg-white dark:bg-slate-800 shadow px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-y-auto">
                <table className="w-full whitespace-nowrap">
                    ...
                    <tbody className="w-full">
                        {active_users && active_users.map(({ id, firstname, lastname, email, age, country, recidency_status, ethnic_origin, profile_image, highest_education, current_profession, prayer_frequency, sect, created_at, profile_step  }) => (
                            <tr key={id} className={`h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100`}>
                                ...
                                <td className="px-7 2xl:px-0">
                                    ...
                                    {show==id &&  <div className="dropdown-content shadow w-24 absolute z-30 right-0 mr-6 ">
                                        <div className="text-xs w-full bg-slate-800 text-white hover:bg-red-700 py-2 px-4 cursor-pointer hover:text-white">
                                            {/* <p>Activate {id}</p> */}
