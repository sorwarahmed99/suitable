        ...
        >
            <div className="bg-white shadow px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-y-auto">
                <table className="w-full whitespace-nowrap">
                    ...
                    {users.map(({ id, firstname, lastname, email, age, country, recidency_status, ethnic_origin, profile_image, highest_education, current_profession, prayer_frequency, sect, created_at, profile_step  }) => (
                            ...
                            <td className="pl-4">
                                <div className="flex items-center">
                                    <div className="w-10 h-10">
                                        ...
                                        {profile_image && ( 
                                          <img src={`http://localhost:3000/uploads/user-images/${profile_image}`} alt={`${firstname}'s Profile photo`}  className="w-full h-full" />
                                         )}
                                    </div>
                                    <div className="pl-4">
