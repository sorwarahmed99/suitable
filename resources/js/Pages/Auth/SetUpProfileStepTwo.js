    ...
    return <Guest
        ...
        <div className="">
            <div className="flex mb-2 justify-between items-center">
                ...
                <p className="mt-6 text-xl font-bold text-purple-600 dark:text-purple-50">30%</p>
            </div>
            <div className="h-2 w-full bg-slate-400  dark:bg-slate-600 relative rounded-full">
                <div className="h-2 w-[120px] bg-slate-800  dark:bg-slate-50 absolute z-50 rounded-full"></div>
            </div>
            {/* <p className="text-xs sm:text-sm mt-4 p-2 font-black leading-snug tracking-normal dark:text-slate-100">Be yourself, your match will be depending on your answers. 
                If you don't like to answer please select "Prefer not say option"
            </p> */}
        </div>
        ...
        <form onSubmit={submit}>
            ...
            <div className="mt-4">
                ...
                <select
                    ...
                    value={data.country}
                >
                    <option className="text-slate-500 dark:text-slate-200" value={''}>Select your country</option>
                    {sortedcs.map((country) => {
                        return (
                            <option className="text-slate-500 dark:text-slate-200" key={country.code} value={country.name}>
                                {country.name}
                            </option>
                        );
                    })}
            ...
            <h3 className="mt-4 font-semibold text-sm text-gray-600 dark:text-slate-200 border-b border-gray-200">Back home address</h3>
            ...
            <div className="mt-4">
                ...
                >
                    <option className="text-slate-500 dark:text-slate-200" value={''}>Select back home country</option>
                    {backhomecountries.map((backhomecountry) => {
                        return (
                            <option className="text-slate-500 dark:text-slate-200" key={backhomecountry.code} value={backhomecountry.name}>
